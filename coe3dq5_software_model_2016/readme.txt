Readme for CoE3DQ5 Project Software Model 2016
...
encode_all:
This encodes the .ppm file to a .mic10 file (McMaster Image Compression, revision 10).
...
decode_m3:
This is a reference for milestone 3 in hardware. The .mic10 file is lossless decoded
